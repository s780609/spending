...
export function Nav() {
  return (
    <header className="bg-white ring-1 ring-gray-950/5">
      <nav className="mx-auto flex max-w-3xl items-center gap-4 px-4 py-3 sm:gap-6">
        <span className="hidden font-mono text-xs uppercase tracking-wider text-gray-600 sm:inline">
          Spending
        </span>
        <Link
          href="/"
